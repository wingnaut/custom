(function () {
        ...
        bot.commands.smithCommand = {
          ...
          functionality: function (chat, cmd) {
            ...
            if (!bot.commands.executable(this.rank, chat)) return void (0);
              ...
              API.sendChat("http://files.digitaltrends.com/images/canadian_club_pour.gif");
            }
          }
        };
    ...
    localStorage.setItem("basicBotsettings", JSON.stringify({
        ...
        scriptLink: 'https://cdn.jsdelivr.net/gh/wingnaut/source@bc67b3ece702fbbdcf75f4da4a946e0e73432da0/basicBot.js',
    ...
    $.getScript("https://cdn.jsdelivr.net/gh/wingnaut/source@bc67b3ece702fbbdcf75f4da4a946e0e73432da0/basicBot.js", extend);
